...
// Chain-signature driven subsack growth:
// A subsack only promotes when the SAME causal chain sequence fires it
// repeatedly — the journey validates the resolution, not time or score.
// ============================================================================
